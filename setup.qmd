...
## How to access earthdata with R

Borrowed from https://urs.earthdata.nasa.gov/documentation/for_users/data_access/r
...
Before using the script, set up your ~/.netrc file as listed here: https://wiki.earthdata.nasa.gov/display/EL/How+To+Access+Data+With+cURL+And+Wget
